...
class ArticlesRepositoryImpl implements ArticlesRepository {
  ...
  @override
  Future<void> markReadedArticles(List<String> articlesIds) async {
    _mockArticles = _mockArticles.map((e) => articlesIds.contains(e.id) ? e.copyWith(readed: true) : e).toList();
  }
}
